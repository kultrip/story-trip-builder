  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section id="calculator" className="py-20 md:py-32 bg-muted/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-5xl font-bold mb-4">See Your ROI</h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Estimate the uplift Kultrip can generate for your agency.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="p-8 hover:shadow-xl transition-shadow">
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-primary">✓</span>
                  <span className="text-sm">Agency's data integration (CRM, experiences)</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary">✓</span>
                  <span className="text-sm">AI recommendation system</span>
                </li>
              </ul>
              <Button variant="outline" className="w-full" onClick={() => navigate("/signup")}>
                Get Started
